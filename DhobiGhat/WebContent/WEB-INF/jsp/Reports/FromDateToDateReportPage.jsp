			...
			<div id="custom_styles" class="col-md-12 layout-spacing col-md-12">
				<div class="statbox widget box box-shadow">
					<div class="widget-content widget-content-area">
					  <form action="getFromToDateReport.html" target="_blank" method="post">
						<div class="form-row">
							<div class="col-md-4 mb-4">
								<label for="mobileNo">Select From Date</label> 
									<input id="orderDate" class="form-control flatpickr flatpickr-input active"
									type="date" placeholder="Select From Date.." style="color: green;" 
									onchange="onOrderDateChange()" required name="fromDate">
								<div class="valid-feedback">Looks good!</div>
								<div class="invalid-feedback">Please Enter!</div>
							</div>
							<div class="col-md-4 mb-4">
								<label for="mobileNo">Select To Date</label> 
									<input id="orderDate" class="form-control flatpickr flatpickr-input active"
									type="date" placeholder="Select To Date.." style="color: green;" 
									onchange="onOrderDateChange()" required name="toDate">
								<div class="valid-feedback">Looks good!</div>
								<div class="invalid-feedback">Please Enter!</div>
							</div>
						</div>
